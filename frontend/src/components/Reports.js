      ...
      <div className="flex">
        <button
          className={`py-2 px-4 text-sm font-medium ${
            activeTab === 0 ? 'text-blue-500 border-b-2 border-blue-500' : 'text-gray-500'
          }`}
        ...
        <button
          className={`py-2 px-4 text-sm font-medium ${
            activeTab === 1 ? 'text-blue-500 border-b-2 border-blue-500' : 'text-gray-500'
          }`}
        ...
        <button
          className={`py-2 px-4 text-sm font-medium ${
            activeTab === 2 ? 'text-blue-500 border-b-2 border-blue-500' : 'text-gray-500'
          }`}
